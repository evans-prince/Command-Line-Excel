...
void test_update_dependencies_valid() {
    printf("Running test: update_dependencies (Valid Case)...\n");
    ...
    if (s->grid[rowA][colA].num_parents == 2 &&
        ...
        printf("PASS: Dependencies updated correctly.\n");
    } else {
        printf("FAIL: Dependencies not updated properly.\n");
    }
...
void test_update_dependencies_invalid(void) {
    printf("Running test: update_dependencies (Invalid Cell)...\n");
    ...
    if (strcmp(message, "Invalid cell reference") == 0) {
        printf("PASS: Invalid cell reference handled correctly.\n");
    } else {
        printf("FAIL: Invalid cell reference not handled properly.\n");
    }
