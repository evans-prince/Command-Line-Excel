...
void test_eval_formula(void){
    ...
    set_cell_value(test_sheet,"C3",0);
    ...
    assert(eval_formula(test_sheet,"5","C3","/")==INT_MIN);
    assert(eval_formula(test_sheet,"A1","C3","/")==INT_MIN);
    assert(eval_formula(test_sheet,"A1","0","/")==INT_MIN);
...
int main(void){
    printf("Running tests for formula_parser\n");
